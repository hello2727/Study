...
public class MainActivity extends AppCompatActivity {
    ...
    public void insertPerson() {
        ...
        Uri uri = new Uri.Builder().build().parse(uriStr); //uri객체 만들어짐
    ...
    public void queryPerson() {
        try {
            String uriStr = "content://org.techtown.provider/person"; //기본 uri객체
    ...
    public void updatePerson() {
        ...
        String selection = "mobile = ?"; //조건문(mobile찾고)
        String[] selectionArgs = new String[] {"010-1000-1000"}; //조건문(왼쪽 번호가진 Args찾기)
    ...
    public void deletePerson() {
        ...
        String selection = "name = ?"; //조건문(name찾고)
        String[] selectionArgs = new String[] {"john"}; //조건문(왼쪽 이름가진 Args찾기)
